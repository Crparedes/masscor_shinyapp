    ...
    tabBox(
      ...
      tabPanel(
        ...
        fluidRow(
              ...
              div(class = "tabBox2", style = 'font-size:13px;',
                tabBox(
                  ...
                  tabPanel(
                    ...
                    tags$div(id = "inline", 
                             fluidRow(
                               column(6, fluidRow(column(11, offset = 1, numericInput(ns('IndErrorPoints'), label = ReqField('No. of calibration points'), min = 2, max = 20, value = 10, step = 1)))),
          ...
          column(
            6, box(width = 12, title = h4('Human-readable document preview:'), tags$hr(), verbatimTextOutput(ns('primitive'))))
          )
        )
    ), 
    column(1,tags$br()), 
