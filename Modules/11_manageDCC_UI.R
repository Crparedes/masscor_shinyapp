manageDCC.UI <- function(id) {
  ...
  fluidRow(column(
    ...
    {conditionalPanel(
      ...
      box(
        width = 12, title = h4('NAWI DCC FILE:'),
  ...
  column(
    6, box(
      width = 12, title = h4('Human-readable document preview:'), tags$hr(), 
