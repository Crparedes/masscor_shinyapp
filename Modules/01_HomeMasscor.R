homeMasscor.UI <- function(id) {
  ns <- NS(id)
  column(
    width = 6, offset = 1, tags$br(), #tags$br(),
    ...
    h4("The R package", tags$a(href = "https://CRAN.R-project.org/package=masscor", tags$b("masscor"), target = "_blank"), "provides classes, functions
       ...
       tags$b("masscor"), "presents a prototipe of Digital Calibration Certificate (DCC) for NAWIs. The NAWI DCC is then used to 
       ...
       tags$br(), tags$br(),
       "The version of the DCC proposed in massccor does not align to the", 
       ...
       "The main purpuse of the", tags$b("masscor NAWI DCC"), "is to serve to the R users of the metrological community that use NAWIs in their measurement processes and R in their data treatment."),
    tags$br(), tags$br(),
